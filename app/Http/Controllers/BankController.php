...
class BankController extends Controller{
    ...
    public function bankpanal(){        
        ...
        $data = DB::select("
            SELECT fdr_models.*, bankdatamodels.*, branchdatamodels.*, 'users.name as auth_name', users.email as authemail, users.name as auth_name, users.is_active as auth_status 
            FROM fdr_models
