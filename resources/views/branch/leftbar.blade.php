  ...
  <div class="sidebar d-none d-md-block">
        ...
        <a href="{{ url('/branch') }}" style="font-size: 15px; font-weight: 500; text-decoration:none;">FDR Manage</a>
        ...
        <a href="" style="font-size: 15px; font-weight: 500; text-decoration:none;">Bank Info</a>
    </div>