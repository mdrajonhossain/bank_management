            ...
            <form action="{{url('/fdrformsend')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row" style="margin-top:20px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <span style="color: red; font-size: 13px; line-height: 18px;">*</span>
                        <input type="text" class="form-control" name="nominee_name" pattern="[a-zA-Z\s]+" required>
                    </div>
                ...
                <div class="row" style="margin-top: 20px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <span style="color: red; font-size: 13px; line-height: 18px;"></span>
                        <input type="number" class="form-control" name="nominee_etin" pattern="[a-zA-Z\s]+" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label for="exampleInputEmail1" class="form-label"
                            ...
                            Code <span style="font-size: 10px !important"> <span
                                    style="color: red; font-size: 13px; line-height: 18px;">* </span>Enter Atleast 4
                                digit</span></label>
                ...
                <div class="row" style=" margin-top:20px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <span style="color: red; font-size: 13px; line-height: 18px;">*</span>
                        <input type="text" class="form-control" name="agent_name" pattern="[a-zA-Z\s]+" required>
                    </div>
